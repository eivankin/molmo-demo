...
def load_model():
    ...
    processor = AutoProcessor.from_pretrained(
        'allenai/MolmoE-1B-0924', # maybe try quantized https://huggingface.co/reubk/MolmoE-1B-0924-NF4 ?
...
def draw_pointing_marker(image, coordinates, marker_size=20, line_width=3, marker_color="red"):
    """
...
class PointingDemoImages(StrEnum):
    ...
    CAT = "https://cdn.thewirecutter.com/wp-content/uploads/2018/04/catbeds-lowres-2.jpg"
    CAR_ICONS = "https://i.pinimg.com/originals/2f/b3/9b/2fb39ba5f7074cd409c1dfd45db4b1b6.jpg"
...
def generate_response(image, prompt, task_type):
    ...
    try:
        ...
        # For pointing task, extract coordinates
...
pointing_examples = [
    [create_demo_image(demo_image), demo_image.get_prompt()] for demo_image in PointingDemoImages
]
